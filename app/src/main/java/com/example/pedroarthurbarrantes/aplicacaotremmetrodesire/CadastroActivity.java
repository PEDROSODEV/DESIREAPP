    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(CadastroActivity.this,"Estação adicionada com sucesso!",Toast.LENGTH_SHORT).show();
        ...
        adapter.setOnItemClickListener(new ItemClickListener() {
            ...
            public void OnItemClick(int position, EstacaoData userData) {
                ...
                builder = new AlertDialog.Builder(CadastroActivity.this);
                builder.setTitle("Update User Info");
                builder.setCancelable(false);
                View view = LayoutInflater.from(CadastroActivity.this).inflate(R.layout.dialog_update,null,false);
    ...
    private void InitUpdateDialog(final int position, View view) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(CadastroActivity.this,"Registro atualizado!",Toast.LENGTH_SHORT).show();
